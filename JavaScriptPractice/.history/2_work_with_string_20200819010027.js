...
const output = logPerson`Name: ${personName}, age: ${personAge}, so funny`
const output2 = logPerson`Name: ${personName2}, age: ${personAge2}`
console.log(output)                         // Name: Anny, age: 26, so funny,       тут 3 строчки как и должно быть
console.log(output2)                        // Name: Alla, age: Еще не родился,     тут 2 но все равно все работает 
