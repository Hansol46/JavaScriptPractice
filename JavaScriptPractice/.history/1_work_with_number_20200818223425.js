...
console.log((0.4 + 0.2).toFixed(1))                        // Method toFixed оставляет в скобках число после запятой.
console.log(+(0.4 + 0.2).toFixed(1))                       // + в начале превращает наше число в число(в предыдущем примере 0.6 это строка)
