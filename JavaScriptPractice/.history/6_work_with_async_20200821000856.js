...
f3().then(console.log(f3()))         // Promise { 'Hello, guys!' }


// [3] Await

// work only in async function 
// await заставляет ждать до тех пор пока промис справа от await не выполнится 
// const value = await promise 

async function f( ) { 
const promise = new Promise((resolve, reject) => {
    return setTimeout( () => resolve('готово!'), 2500)
})
// let results = await promise          // будет ждать пока промис не выполнится 
console.log(results);
}
