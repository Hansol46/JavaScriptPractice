...
const reverseText = text.split()                    // преобразует строку в массив
console.log(reverseText)                            // [ 'Hello, world!' ]

const reverseText2 = text.split('')                 // позволяет разделить каждый символ 
console.log(reverseText2)                           // [ 'H','e','l','l','o',',',' ','w','o','r','l','d','!' ]

const reverseText3 = text.split('').reverse()
console.log(reverseText3)                           // [ 'H','e','l','l','o',',',' ','w','o','r','l','d','!' ]

const reverseText4 = text.split('')
.reverse().join('')                                 // join позволяет превратить массив в строку
console.log(reverseText4)                           // !dlrow ,olleH


const allMoney = people.filter( person => person.money > 1000)
.reduce((accumulator, person)=> {                  // применяется reduce к каждому элементу массива
    accumulator += person.money                    // accumulator - первое значение 
    return accumulator
}, 0)
