...
console.log(newAddress)                                             //{ country: 'Russia', city: 'Moscow', concat: [Function: concat] } 
// получаем копию, но так же мы можем менять поля или добавлять новые
const newAddress2 = {...address, country: 'USA', president: 'Tramp'}
console.log(newAddress2)                                            //{ country: 'USA', city: 'Moscow', concat: [Function: concat], president: 'Tramp' } 